...
(function () {
	function r(e, n, t) {
		...
		function calculator() {
			...
			function tabHideBalcon(elementNumber) {
				...
				for (var _i4 = elementNumber; _i4 < popupBalconBigIcons.length; _i4++) {
					...
					popupBalconIcons[_i4].style.width = '20%';
				}
			}
		...
		function tab() {
			...
			var glassSlide = document.getElementsByClassName('glazing_block'),
			...
			function tabHide(elementNumber) {
				...
				for (var i = elementNumber; i < glassContentWarm.length; i++) {
			...
			glassWindow.addEventListener('click', function (event) {
				...
				if (target.classList.contains('glazing_block') || target.classList.contains('imgOfwork') || target.classList.contains('typeOfwork')) {
					...
					for (var i = 0; i < glassSlide.length; i++) {
		...
		function tabForWindows() {
			var decorItem = document.getElementsByClassName('decoration_item  wow fadeInUp'),
			...
			function tabHide(elementNumber) {
				...
				for (var i = elementNumber; i < decorItem.length; i++) {
			...
			for (var j = 0; j < decorItem.length; j++) {
				...
				decorItem[j].addEventListener('click', function (event) {
					...
					if (target.classList.contains('decoration_item') || target.classList.contains('no_click') || target.classList.contains('decoration_name')) {
						...
						for (var i = 0; i < decorItem.length; i++) {
